...
learn R and RStudio. Learning R is a big topic and we will not be able to
cover everything, by the end of this session we hope that you will feel comfortable starting to use R on your own for working with Git and GitHub.

## Learning Objectives

-   Navigate RStudio
-   Use Posit Cloud (previously known as RStudio cloud)
